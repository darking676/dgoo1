					...
					<c:forEach items="${list }" var="row" varStatus="status">
						<tr>
							<td>
								...
								<input type="hidden" id="product_id${num }" value="${row.wish_p_id }">
								<input type="hidden" id="number${num }" value="${row.wish_number }"> 
								<input type="hidden" id="sub_pay${num }" value="${row.wish_number * row.p_price}"> 
							</td>
							<td>${row.p_name }</td>
							<td>${modi_num[modi_number] }</td> 
							<td>${row.p_price }</td>
							<td>${row.wish_number * row.p_price }</td>
						</tr>
				<c:set var="tot" value="${tot + row.wish_number * row.p_price }" />
